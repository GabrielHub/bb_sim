...
5. Add Stat Class, players will instead have 2 Stats, one that contains their changing stats, one for their const season stats. A team will have a Stat as well.
*/
